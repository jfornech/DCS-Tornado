...
Tornado_GR4 =  {
	...
	{
		{
			...
			desrt    = 'Tornado_GR4_destr'; -- Name of destroyed object file name
			fire  	 = { 300, 2}; -- Fire on the ground after destoyed: 300sec 2m
			username = 'Tornado_GR4';
			index    =  WSTYPE_PLACEHOLDER;
		},
		{
			name  = "Tornado_GR4_destr";
			file  = "Tornado_GR4-destr";
			fire  = { 240, 2};
		},
	...
	-------------------------
	M_empty 					= 14090, -- kg with pilot and nose load (Check OK)
	M_nominal 					= 18700, -- kg (Empty Plus Full Internal Fuel) Check OK)
